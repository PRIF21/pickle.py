...
while pop<5 :
    ...
    # if ch2!='Красный' or ch2!='красный' or ch2!='Черный' or ch2!='черный': # не понимаю почему но это не работает
    #     print('Вы ввели недопустимые данные ')                             # хотел сделать чтобы проверяло
    #                                                                        # введены ли нужные данные
    #     break
    pop += 1
